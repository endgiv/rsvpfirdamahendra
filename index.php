...
<html lang="en">
   <head>
      <!-- Metas -->
      <meta charset="utf-8">
      <title>Firda Mahendra Wedding</title>
      <meta name="description" content="Firda Mahendra Wedding Invitation">
                        ...
                        <div class="mx-auto icon-round mb-4 mb-md-4  bg-icon-primary">
                           <svg class="icon-svg" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 70.8 102.2" enable-background="new 0 0 70.8 102.2;" xml:space="preserve">
                              <path class="st0" opacity="0.3" d="M35.4,70.8c5.4,0,10-1.9,13.9-5.8c3.8-3.8,5.8-8.5,5.8-13.9V19.7c0-5.4-1.9-10-5.8-13.9C45.4,1.9,40.8,0,35.4,0
                                 c-5.4,0-10,1.9-13.9,5.8c-3.8,3.8-5.8,8.5-5.8,13.9v31.5c0,5.4,1.9,10,5.8,13.9C25.4,68.8,30,70.8,35.4,70.8z" fill="#59745d" />
                              <path class="st1" d="M69.6,40.5c-0.8-0.8-1.7-1.2-2.8-1.2c-1.1,0-2,0.4-2.8,1.2c-0.8,0.8-1.2,1.7-1.2,2.8v7.9
                                 ...
                                 c6-6.7,9.1-14.6,9.1-23.6v-7.9C70.8,42.2,70.4,41.3,69.6,40.5z" fill="#59745d" />
                           </svg>
                        </div>
      ...
      C132.3154,15.988,132.5641,15.4404,132.5641,14.8073z"/>
         ...
         <section class="footer-copyright spacer-double-sm bg-white text-center">
            ...
            <p class="text-muted small d-block mb-0">
                      <a data-file="001-toast" href="https://www.endgiv.com">endgiv</a> - <a href=" https://www.instagram.com/endgiv" rel="nofollow">instagram</a><br><br></p>
         </section>
         <!--To the top-->
